...
#define I2S_WS_PIN    NRF_GPIO_PIN_MAP(0, 9)   // LRCK (Word Select)
#define I2S_SCK_PIN   NRF_GPIO_PIN_MAP(0, 10)   // Serial Clock (SCK)
#define I2S_SDIN_PIN  NRF_GPIO_PIN_MAP(1, 6)   // Serial Data In (from microphone)
#define I2S_SDOUT_PIN NRF_GPIO_PIN_MAP(1, 4)  // Serial Data Out (to speaker)
